// 5×7 bitmap font for printable ASCII (0x20–0x7E), matching the HD44780-class
// character LCD used by the TSEC/KL-43C. Each glyph is 7 rows × 5 columns;
// rows are 5-bit numbers with bit 4 = leftmost pixel.
